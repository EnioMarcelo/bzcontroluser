...
<!--MODAL-->
<div id="modal-btn-icon" class="bz_modal_icon">
    <div class="bz_modal_box">
        ...
        <div id="bz_modal_content">
            <iframe src="<?= site_url('projectbuildcrud/icons'); ?>" id="info" class="iframe" name="info" seamless="" height="100%" width="100%"></iframe>
        </div>
...
<script>
    $(function () {
        ...
        //MODAL OPEN
        $('.j-btn-app-icon').click(function () {
            $('.bz_modal_icon').css('display', 'block');
        });
    });
</script>