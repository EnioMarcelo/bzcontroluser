...
//            $("#modalBuildApp").find('iframe').hide();
            ...
            $('#modalBuildAppIframe').load(function () {
                ...
                $('#modalBuildApp').find("#carregando").addClass('hidden');
