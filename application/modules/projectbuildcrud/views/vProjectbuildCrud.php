                ...
                <tbody>
                    ...
                    <?php foreach ($_result['results_paginacao'] as $_row): ?>
                        ...
                        <tr data-action="<?= $_edit; ?>">
                            <td class="j-btn-edit btn-show-modal-aguarde mouse-cursor-pointer text-center"><input class="checkbox checkbox-unit flat-red text-center" type="checkbox" name="btn-delete[]" value="<?= $_row->id; ?>"></td>
                            <td class="j-btn-edit btn-show-modal-aguarde mouse-cursor-pointer text-center" style="width:5px;"><?= $_c; ?></td>
                            <td class="j-btn-edit btn-show-modal-aguarde mouse-cursor-pointer text-center" style="width:5px; color:#ccc"><?= $_row->id; ?></td>
                            <td class="j-btn-edit btn-show-modal-aguarde mouse-cursor-pointer col-md-3">&nbsp;<?= $_row->app_nome; ?></td>
                            <td class="j-btn-edit btn-show-modal-aguarde mouse-cursor-pointer col-md-6">&nbsp;<?= $_row->app_titulo; ?></td>
                            <td class="j-btn-edit btn-show-modal-aguarde mouse-cursor-pointer col-md-2">&nbsp;<?= $_row->tabela; ?></td>
...
<!--                                <a href="<?= $_edit; ?>" class="btn btn-xs btn-primary btn-show-modal-aguarde">
                                ...
                                <a class="btn btn-xs bg-purple" data-toggle="modal" data-target="#modalBuildApp" data-build="<?= strtolower($_buildApp); ?>" data-width="50%" data-height="350px" data-title="Gerando Aplicação">
                                ...
                                <a class="btn btn-xs bg-maroon-gradient" data-toggle="modal" data-target="#modalBuildApp" data-build="<?= strtolower($_buildApp); ?>" data-width="90%" data-height="500px" data-title="Executando Aplicação">
