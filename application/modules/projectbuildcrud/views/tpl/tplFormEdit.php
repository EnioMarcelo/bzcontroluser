 ...
 */
  ...
  <!-- OPEN FORM -->
  <?= form_open(site_url($this->router->fetch_class() . '/edit/'. $dados->{{primary_key_field}} . '?' . bz_app_parametros_url()), 'id="IdFormEDIT_'.$this->router->fetch_class().'" name="formEDIT_'.$this->router->fetch_class().'" role="form" ' ); ?>
