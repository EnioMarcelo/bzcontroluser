...
class Login extends MY_Controller
{
    ...
    private function login($_email, $_senha)
    {
        ...
        if ($_is_login) {
            ...
            $dados_auditoria['creator'] = 'user';
            $dados_auditoria['action'] = 'login';
            $dados_auditoria['description'] = 'Erro ao Efetuar o Login, Email ou Senha não confere. Email[ ' . $this->input->post('email', TRUE) . ' ]';
            add_auditoria($dados_auditoria);
            ...
            set_mensagem_sweetalert('Erro ao efetuar o Login', 'Email ou Senha não confere.', 'error');
