  	...
  	<div class="box">
  		...
  		<div class="box-body no-padding padding-left-10 padding-right-10 margin-top-20">
            ...
            <!-- FORM FIELDS -->
                                            ...
                                            <div id="id" class="form-group has-feedback col-sm-2 hidden ">
                                                <label for="id">ID</label>
                                                <input type="number" name="id" class="form-control" placeholder="" value="<?=set_value("id",isset($dados->id) ? $dados->id : set_value("id"));?>" pattern="[0-9]" onkeypress="return (event.charCode >= 48 && event.charCode <= 57) ||  event.charCode == 0 " disabled-formedit  />
                                                <?= $_error; ?>
                                            </div>
