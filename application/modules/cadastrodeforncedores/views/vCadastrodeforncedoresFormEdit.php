 ...
 */
  ...
  <!-- OPEN FORM -->
  <?= form_open(site_url($this->router->fetch_class() . '/edit/'. $dados->cpf . '?' . bz_app_parametros_url()), 'id="IdFormEDIT_'.$this->router->fetch_class().'" name="formEDIT_'.$this->router->fetch_class().'" role="form" ' ); ?>
       ...
       <div class="box box-primary">
        ...
        <div class="box-body inputs">
          ...
          <!-- FORM FIELDS -->
                                            ...
                                            <?php $_error = form_error("cpf", "<small class='text-danger col-xs-12 bz-input-error'>", "</small>"); ?>
                                            <div id="cpf" class="form-group has-feedback col-sm-12">
                                                <label for="cpf">cpf</label>
                                                <input type="text" name="cpf" class="form-control   " placeholder="" autofocus  value="<?=set_value("cpf",!empty($dados->cpf) ? $dados->cpf : set_value("cpf"));?>" />
                                                <?= $_error; ?>
                                            </div>
                                            ...
                                            <div id="nome" class="form-group has-feedback col-sm-12">
                                                ...
                                                <input type="text" name="nome" class="form-control uppercase  " placeholder=""  value="<?=set_value("nome",!empty($dados->nome) ? $dados->nome : set_value("nome"));?>" />
                                                <?= $_error; ?>
                                            </div>
