                ...
                <div class="box-body">
                    ...
                    <div class="form-group has-feedback">
                        ...
                        <div class="input-group">
                            ...
                            <input type="text" name="nome" class="form-control" placeholder="Nome do Usuário" value="<?= (set_value('nome')) ? set_value('nome') : $dados->nome; ?>" maxlength="250" autofocus/>
                        </div>
                        <?= $_error; ?>
                    </div>
                    ...
                    <div class="form-group has-feedback">
                        ...
                        <div class="input-group">
                            ...
                            <input type="text" class="form-control" placeholder="Email do Usuário" value="<?= (set_value('email')) ? set_value('email') : $dados->email; ?>" maxlength="250" disabled/>
                        </div>
                        <?= $_error; ?>
                    </div>
                    ...
                    <div class="form-group has-feedback">
                        ...
                        <div class="form-group">
                            <label>
                                <input type="checkbox" name="super_admin" class="flat-green" <?= ($dados->super_admin == 'Y' || $dados->super_admin == 'on') ? 'checked' : ''; ?>>
                                Ativado
                            </label>
                        </div>
                        <?= $_error; ?>
                    ...
                    <input type="hidden" name="email" value="<?= (set_value('email')) ? set_value('email') : $dados->email; ?>" readonly/>
