            ...
            <div class="box <?= bz_box_color(___BZ_LAYOUT_SKINCOLOR___); ?> margin-top-15 padding-right-10">
                ...
                <div class="box-body">
                    ...
                    <div class="form-group has-feedback">
                        ...
                        <div class="input-group">
                            ...
                            <input type="text" name="nome" class="form-control" placeholder="Nome do Usuário"
                                   value="<?= set_value('nome'); ?>" maxlength="250" autofocus/>
                        </div>
                        <?= $_error; ?>
                    </div>
                    ...
                    <div class="form-group has-feedback">
                        ...
                        <div class="input-group">
                            ...
                            <input type="text" name="email" class="form-control" placeholder="Email do Usuário"
                                   value="<?= set_value('email'); ?>" maxlength="250"/>
                        </div>
                        <?= $_error; ?>
                    </div>
                    ...
                    <div class="container-fluid padding-top-15">
                            ...
                            <div class="form-group">
                                <label>
                                    <input type="checkbox" name="super_admin"
                                           class="flat-green" <?= ($this->input->post('super_admin') == 'on') ? 'checked' : ''; ?>>
                                    Ativado
                                </label>
                            </div>
                            <?= $_error; ?>
                        ...
                        <div class="form-group has-feedback col-lg-2 col-md-2 col-sm-2 col-xs-6">
