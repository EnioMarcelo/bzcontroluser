    ...
    <section class="content-header header-dashboard" style="margin-top: 0px; margin-left: -15px; margin-bottom: 20px;">
        <h1>
            ...
            <small class="input-group-btn margin-left-10">
                ...
                <button type="button" id="btn-delete" class="btn btn-sm btn-danger disabled" name="btn-del"
                        value="btn-del">
    ...
    <div class="row">
        ...
        <div class="box <?= bz_box_color(___BZ_LAYOUT_SKINCOLOR___); ?>">
                ...
                <div class="box-tools">
                    ...
                    <div class="input-group margin-top-10">
                        ...
                        <div class="input-group-btn">
                            <button class="btn btn-sm btn-primary btn-show-modal-aguarde j-tooltip"
                                    data-placement="bottom" data-toggle="tooltip" data-original-title="Pesquisa"><i
                            ...
                            <a href="<?= site_url($this->router->fetch_class()); ?>"
                               ...
                               data-toggle="tooltip" data-original-title="Limpar"><i
            ...
            <div class="box-body table-responsive no-padding margin-top-20">
                ...
                <!-- TABLE -->
                <table id="IdTableGridList_<?= $this->router->fetch_class(); ?>"
                       class='table table-hover table-striped table-bordered table-mark-row'>
                    ...
                    <tr>
                        ...
                        <th class="col-md-6">Nome Usuário</th>
...
//                                            $_apps .= "<a " . $_app_class_inativo . " href='" . site_url('apps/edit/') . $_arr['app_name'] . "?btnvoltarorigem=usuarios&" . bz_app_parametros_url() . "'><div class='text-left'><i class='fa fa-fw fa-check-square margin-right-5'></i>" . $_arr['app_descricao'] . '</div></a>';
                                ...
                                <?php if ($_apps): ?>
                                    <small class="label pull-right bg-aqua" style="cursor: pointer"
                                           ...
                                           data-toggle="popover" data-content="<?= $_apps; ?>">A</small>
                                <?php endif; ?>

                                <?php if ($_grupos): ?>
                                    <small class="label pull-right bg-aqua-active margin-right-5"
                                           style="cursor: pointer" title="<p style='font-size:1.2em'>Grupos</p>"
                                           data-placement="bottom" data-toggle="popover"
                                           data-content="<?= $_grupos; ?>">G</small>
                                <?php endif; ?>
                                <!-- END TAG GRUPOS E APPS DO USUÁRIO -->

                                <!-- TAG DE USUÁRIO SUPER ADMIN -->
                                <?php if ($_row->super_admin == 'Y'): ?>
                                    <small class="label pull-right bg-black-active j-tooltip margin-right-5"
                                           style="cursor: pointer" data-toggle="tooltip"
                                           data-original-title="Super Admin" data-placement="bottom">SA</small>
                                <?php endif; ?>
                            ...
                            <td class="col-md-2 <?= $_j_btn_edit; ?>"><?= $_row->email; ?></td>
                            <td class="col-md-2 <?= $_j_btn_edit; ?>"><?= !empty($_row->app_inicial) ? $this->db->get_where('sec_aplicativos', ['app_name' => $_row->app_inicial])->row()->app_descricao : ''; ?></td>
                            ...
                            <td class="text-center">
                                ...
                                <a class="btn btn-xs btn-warning j-btn-change-pass-user" data-id="<?= $_row->id; ?>"
                                   data-email="<?= $_row->email; ?>" data-nome="<?= $_row->nome; ?>">
                                    <span class="fa fa-key j-tooltip" data-placement="bottom" data-toggle="tooltip"
                                          data-original-title="Alterar Senha"></span>
                                </a>
                                ...
                                <a id="<?= $_row->id; ?>"
                                   class="btn btn-xs <?= $_btn_conected; ?> btn-show-modal-aguarde j-btn-poweroff-user <?= (($_btn_conected_status == 'poweroff') ? 'disabled' : ''); ?> <?= $_btn_conected_disable; ?>"
                                   data-rel="<?= $_btn_conected_status; ?>" data-id="<?= $_row->id; ?>"
                                   data-email="<?= $_row->email; ?>" data-nome="<?= $_row->nome; ?>">
                                    <span class="fa fa-power-off j-tooltip" data-placement="bottom"
                                          data-toggle="tooltip"
                                          data-original-title="<?= $_btn_conected_tooltip_msg; ?>"></span>
                                </a>
