...
<head>
    <meta charset="UTF-8">
    <title>ADMIN <?=bz_strip_tags_content(___BZ_TITULO_SISTEMA___);?>| Esqueci minha senha</title>
...
<div class="login-box">
    <div class="login-logo">
        <a href="<?= site_url(); ?>"><b>Admin</b><?=bz_strip_tags_content(___BZ_TITULO_SISTEMA___);?></a>
    </div><!-- /.login-logo -->
