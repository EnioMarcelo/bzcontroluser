...
<head>
    ...
    <link href="<?= base_url('assets'); ?>/bootstrap/css/bootstrap-clockpicker.min.css" rel="stylesheet"
          type="text/css"/>
    <!-- Bootstrap Button Toggle -->
    <link href="<?= base_url('assets'); ?>/plugins/button-toggle/bootstrap-toggle.min.css" rel="stylesheet"
          type="text/css"/>
    <!--Select 2-->
    ...
    <link href="<?= base_url('assets'); ?>/plugins/datetimepicker/bootstrap-datetimepicker.css" rel="stylesheet"
          type="text/css"/>
    <link href="<?= base_url('assets'); ?>/plugins/timepicker/bootstrap-timepicker.css" rel="stylesheet"
          type="text/css"/>
    ...
    <link href="<?= base_url('assets'); ?>/plugins/linedtextarea/jquery-linedtextarea.css" rel="stylesheet"
          type="text/css"/>
    <!--jQueryUI 1.12.1 CSS-->
    <link href="<?= base_url('assets'); ?>/plugins/jQueryUI/jquery-ui-1.12.1/jquery-ui.min.css" rel="stylesheet"
          type="text/css"/>
    <!--Lightbox Popup-->
    ...
    <!-- jQuery-UI 1.12.1 -->
    <script src="<?= base_url('assets'); ?>/plugins/jQueryUI/jquery-ui-1.12.1/jquery-ui.min.js"
    ...
    <script src="<?= base_url('assets'); ?>/plugins/bootstrap-wysihtml5/bootstrap3-wysihtml5.all.min.js"
            type="text/javascript"></script>
    <script src="<?= base_url('assets'); ?>/plugins/button-toggle/bootstrap-toggle.min.js"
            type="text/javascript"></script>
    <!-- slimScroll -->
    ...
    <script src="<?= base_url('assets'); ?>/plugins/datepicker/locales/bootstrap-datepicker.pt-BR.js"
            type="text/javascript"></script>
    <script src="<?= base_url('assets'); ?>/plugins/datetimepicker/bootstrap-datetimepicker.min.js"
            type="text/javascript"></script>
    <script src="<?= base_url('assets'); ?>/plugins/datetimepicker/bootstrap-datetimepicker.pt-BR.js"
            type="text/javascript"></script>
    ...
    <!--Numbered Line TextArea-->
    <script src="<?= base_url('assets'); ?>/plugins/linedtextarea/jquery-linedtextarea.js"
            type="text/javascript"></script>
    ...
    <!--MACROS JS-->
    <script src="<?= base_url('assets'); ?>/js/macros-js.js" type="text/javascript"></script>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                <button type="button" id="delete-cancel" class="btn btn-outline pull-left btn-show-modal-aguarde"
