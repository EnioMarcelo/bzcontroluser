...
<head>
    <meta charset="UTF-8">
    <title><?= ___BZ_TITULO_SISTEMA___; ?></title>
    ...
    <link href="<?= base_url('assets'); ?>/plugins/button-toggle/bootstrap-toggle.min.css<?='?'.date('YmdHis');?>" rel="stylesheet" type="text/css"/>
    <!--Select 2-->
    <link href="<?= base_url('assets'); ?>/plugins/select2/select2.min.css<?='?'.date('YmdHis');?>" rel="stylesheet" type="text/css"/>
    <!-- Theme style iCheck-->
    ...
    <link href="<?= base_url('assets'); ?>/plugins/datepicker/datepicker2.css<?='?'.date('YmdHis');?>" rel="stylesheet" type="text/css"/>
    ...
    <link href="<?= base_url('assets'); ?>/css/custom-masterPageIframe.css<?='?'.date('YmdHis');?>" rel="stylesheet" type="text/css" />
